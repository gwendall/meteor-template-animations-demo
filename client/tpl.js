var insertRandomItem = function() {
  Items.insert(_.extend(Fake.user(), { pic: "http://accounts-cdn.9gag.com/media/default-avatar/1_" + _.random(0, 182) + "_100_v0.jpg" }));

}

Items = new Mongo.Collection("items", { connection: null });
_.each(_.range(0, 3), insertRandomItem);
